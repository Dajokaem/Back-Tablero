# Documentación Backend - Tablero API
...
* **Docker**: Conteneriza la aplicación y la base de datos.
...
Visual Studio lo hace automáticamente. Manual:
...
* **GET /api/Tablero** → Devuelve información consolidada del tablero 
...
* URL: `http(s)://localhost:<puerto>/swagger/v1/swagger.json`.

### Probar con Postman

1. **Import** el archivo OpenAPI.
2. Crea una **Environment** con `baseUrl`.
3. Ejecuta requests de ejemplo. Guarda ejemplos de respuesta para validar.
